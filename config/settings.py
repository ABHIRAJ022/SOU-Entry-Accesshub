...
LOCATION_ONLINE_THRESHOLD_SECONDS = int(os.getenv('LOCATION_ONLINE_THRESHOLD_SECONDS', '120'))
LOCATION_HISTORY_RETENTION_DAYS = int(os.getenv('LOCATION_HISTORY_RETENTION_DAYS', '30'))
CAMPUS_CENTER_LATITUDE = float(os.getenv('CAMPUS_CENTER_LATITUDE', '23.097214'))
CAMPUS_CENTER_LONGITUDE = float(os.getenv('CAMPUS_CENTER_LONGITUDE', '72.540600'))
CAMPUS_GEOFENCE_RADIUS_METERS = float(os.getenv('CAMPUS_GEOFENCE_RADIUS_METERS', '1000'))
